...
<table  id="myTable">
  ...
  <?php
                    $sql = "SELECT * FROM register JOIN filesave ON 
                    register.pid= filesave.pid AND status=0";
  ...
  <tr>
    ...
    <td><a href="download.php?file=<?php echo urlencode($value['KCSE']); ?>" target="_blank">KCSE</a></td>
       ...
       <td><a href="download.php?file=<?php echo urlencode($value['CV']); ?>" target="_blank">CV</a></td>
        ...
        <td><a href="download.php?file=<?php echo urlencode($value['Certificate']); ?>" target="_blank">Certificate</a></td>

       <td><a href="download.php?file=<?php echo urlencode($value['nid']); ?>" target="_blank">National ID</a></td>
      
       <td><a href="download.php?file=<?php echo urlencode($value['Attachments']); ?>" target="_blank">Professional Letter</a></td>

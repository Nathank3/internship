        ...
        <div class="l-navbar" id="navbar">
            <nav class="nav">
                <div>
                  ...
                  <img src="images\logo\logo.png"  class="img-circle"width="110" height="80">
                    </div> 
...
?>
  <a href="attachment.php" class="collapse__sublink">Attachment</a>
                                <a href="#" class="collapse__sublink">Jobs</a>
                            </ul>
                        </div>
                        ...
                        <a href="manage.php" class="nav__link">
                            ...
                            <span class="nav__name">Account Settings</span>
                        </a>
                    </div>
                </div>
